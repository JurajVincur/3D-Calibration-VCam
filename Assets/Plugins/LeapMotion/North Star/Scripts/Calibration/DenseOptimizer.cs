...
namespace Leap.Unity.AR.Testing
{
    public class DenseOptimizer : MonoBehaviour
    {
        ...
        IEnumerator StartNelderMead()
        {
            ...
            solver.bottomCam = calibration.calibrationDevices[1].webcam.virtualCamera;
            solver.topCam = calibration.calibrationDevices[0].webcam.virtualCamera; //TODO!!!!!!!!!!!!!!!!!
        ...
        public void setTransforms(float[] coordinate)
        {
            ...
            Transform leftCamera = calibration.calibrationDevices[deviceIndex].LeftCamera;
            Transform rightCamera = calibration.calibrationDevices[deviceIndex].RightCamera;
        ...
        public float measureCost()
        {
            ...
            var LeftImageMetrics = calibration.calibrationDevices[deviceIndex].leftImageMetrics;
            var RightImageMetrics = calibration.calibrationDevices[deviceIndex].rightImageMetrics;
